...
void SqlSelectQuery::addCondition(std::string _column, std::string _value, char condition)
{
	whereCondition.push_back(_column + ' ' + condition + ' ' + _value);
}

void SqlSelectQuery::addCondition(std::string _column, int _value, char condition)
{
	whereCondition.push_back(_column + ' ' + condition + ' ' + std::to_string(_value));
}
